...
module "server_template_9" {                                   # <<-- Change to duplicate
...
# -----------------------------------------------------------------------------
  ...
  server_policy_prefix = "${local.az_policy_prefix}-vmw09"         # <<-- Change to duplicate
  ...
  tags = [
    ...
    { "key" : "ServerGroup", "value" : "${local.az_policy_prefix}-vmw09" } # <-- Change to duplicate
  ]
