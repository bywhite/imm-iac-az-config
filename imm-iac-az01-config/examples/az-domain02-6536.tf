...
module "imm_domain_2" {                                                        # <-- change when copying
  source = "github.com/bywhite/imm-iac-az-mods//imm-domain-6536-mod"  #?ref=v1.2.6"
...
# -----------------------------------------------------------------------------
  ...
  policy_prefix = "${local.az_policy_prefix}-domain02"                        # <-- change when copying
  ...
  tags = [
    ...
    { "key" : "domain", "value" : "${local.az_policy_prefix}-domain02" }      # <-- change when copying
  ]
